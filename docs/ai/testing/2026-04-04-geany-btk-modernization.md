...
- Grep check to ensure recently normalized seams (tab-position application, standard dialog naming, and CSS-provider attachment) continue flowing through `gtkcompat.h` helpers rather than growing fresh raw toolkit calls in parallel
