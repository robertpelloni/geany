/* bobguitextattributes.h - text attributes
 *
...
typedef struct _BobguiTextAttributes BobguiTextAttributes;
typedef struct _BobguiTextAppearance BobguiTextAppearance;

struct _BobguiTextAppearance
{
  GdkRGBA *bg_rgba;
  GdkRGBA *fg_rgba;
   ...
   * a paragraph; not when a BobguiTextAppearance is part of a
...
/**
 * BobguiTextAttributes:
 * @appearance: BobguiTextAppearance for text.
 * @justification: BobguiJustification for text.
 * @direction: BobguiTextDirection for text.
 ...
 * @wrap_mode: `BobguiWrapMode` for text.
 ...
 *
 * Using BobguiTextAttributes directly should rarely be necessary.
 * It’s primarily useful with bobgui_text_iter_get_attributes().
 * As with most BOBGUI structs, the fields in this struct should only
 * be read, never modified directly.
 */
struct _BobguiTextAttributes
{
  guint refcount;
...
BobguiTextAttributes* bobgui_text_attributes_new         (void);
BobguiTextAttributes* bobgui_text_attributes_copy        (BobguiTextAttributes *src);
void               bobgui_text_attributes_copy_values (BobguiTextAttributes *src,
                                                    BobguiTextAttributes *dest);
void               bobgui_text_attributes_unref       (BobguiTextAttributes *values);
BobguiTextAttributes *bobgui_text_attributes_ref         (BobguiTextAttributes *values);
