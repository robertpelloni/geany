/* bobguiatspiprivate.h: AT-SPI shared types
 *
...
typedef struct _BobguiAtSpiRoot    BobguiAtSpiRoot;
typedef struct _BobguiAtSpiCache   BobguiAtSpiCache;
typedef struct _BobguiAtSpiContext BobguiAtSpiContext;
