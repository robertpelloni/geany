/* bobguiatspipango.c - pango-related utilities for AT-SPI
 *
 ...
 */
char *
bobgui_pango_get_text_before (PangoLayout           *layout,
                           int                    offset,
                           AtspiTextBoundaryType  boundary_type,
                           int                   *start_offset,
                           int                   *end_offset)
{
  ...
  switch (boundary_type)
    {
    case ATSPI_TEXT_BOUNDARY_CHAR:
      start = bobgui_pango_move_chars (layout, start, -1);
      break;
    ...
    case ATSPI_TEXT_BOUNDARY_WORD_END:
      if (bobgui_pango_is_inside_word (layout, start) &&
    ...
    case ATSPI_TEXT_BOUNDARY_SENTENCE_END:
      if (bobgui_pango_is_inside_sentence (layout, start) &&
 ...
 */
char *
bobgui_pango_get_text_after (PangoLayout           *layout,
                          int                    offset,
                          AtspiTextBoundaryType  boundary_type,
                          int                   *start_offset,
                          int                   *end_offset)
 ...
 */
char *
bobgui_pango_get_text_at (PangoLayout           *layout,
                       int                    offset,
                       AtspiTextBoundaryType  boundary_type,
                       int                   *start_offset,
                       int                   *end_offset)
