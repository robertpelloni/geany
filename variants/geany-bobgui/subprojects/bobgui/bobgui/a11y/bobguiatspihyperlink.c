/* bobguiatspihyperlink.c: AT-SPI Hyperlink implementation
 *
                         ...
                         gpointer               user_data)
{
  ...
  BobguiAccessibleHyperlink *hyperlink = BOBGUI_ACCESSIBLE_HYPERLINK (accessible);
  ...
  if (g_strcmp0 (method_name, "GetObject") == 0)
    {
      ...
      if (index != 0)
      ...
      else
        {
          ...
          GVariant *ref = bobgui_at_spi_context_to_ref (BOBGUI_AT_SPI_CONTEXT (parent_context));
  ...
  else if (g_strcmp0 (method_name, "GetURI") == 0)
    {
      ...
      if (index != 0)
      ...
      else
        {
          ...
          uri = bobgui_accessible_hyperlink_get_uri (hyperlink);
                               ...
                               gpointer          user_data)
{
  ...
  bobgui_accessible_hyperlink_get_extents (hyperlink, &bounds);
...
bobgui_atspi_get_hyperlink_vtable (BobguiAccessible *accessible)
{
  if (BOBGUI_IS_ACCESSIBLE_HYPERLINK (accessible))
