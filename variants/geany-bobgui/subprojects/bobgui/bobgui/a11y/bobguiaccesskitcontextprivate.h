/* bobguiaccesskitcontextprivate.h: AccessKit BobguiATContext implementation
 *
...
#define BOBGUI_TYPE_ACCESSKIT_CONTEXT (bobgui_accesskit_context_get_type())

G_DECLARE_FINAL_TYPE (BobguiAccessKitContext, bobgui_accesskit_context, BOBGUI, ACCESSKIT_CONTEXT, BobguiATContext)
