...
#define BOBGUI_COUNTING_BLOOM_FILTER_BITS (12)

/* The necessary size of the filter */
#define BOBGUI_COUNTING_BLOOM_FILTER_SIZE (1 << BOBGUI_COUNTING_BLOOM_FILTER_BITS)

typedef struct _BobguiCountingBloomFilter BobguiCountingBloomFilter;

struct _BobguiCountingBloomFilter
{
  guint8        buckets[BOBGUI_COUNTING_BLOOM_FILTER_SIZE];
};

static inline void      bobgui_counting_bloom_filter_add           (BobguiCountingBloomFilter         *self,
                                                                 guint16                         hash);
static inline void      bobgui_counting_bloom_filter_remove        (BobguiCountingBloomFilter         *self,
                                                                 guint16                         hash);
static inline gboolean  bobgui_counting_bloom_filter_may_contain   (const BobguiCountingBloomFilter   *self,
                                                                 guint16                         hash);


/*
 * BOBGUI_COUNTING_BLOOM_FILTER_INIT:
 *
 ...
 */
#define BOBGUI_COUNTING_BLOOM_FILTER_INIT {{0}}

/*
 * bobgui_counting_bloom_filter_add:
 * @self: a `BobguiCountingBloomFilter`
 ...
 **/
static inline void
bobgui_counting_bloom_filter_add (BobguiCountingBloomFilter *self,
                               guint16                 hash)
{
  guint16 bucket = hash % BOBGUI_COUNTING_BLOOM_FILTER_SIZE;
...
/*
 * bobgui_counting_bloom_filter_remove:
 * @self: a `BobguiCountingBloomFilter`
 * @hash: a hash value to remove from the filter
 *
 * Removes a hash value from the filter that has previously
 * been added via bobgui_counting_bloom_filter_add().
 **/
static inline void
bobgui_counting_bloom_filter_remove (BobguiCountingBloomFilter *self,
                                  guint16                 hash)
{
  guint16 bucket = hash % BOBGUI_COUNTING_BLOOM_FILTER_SIZE;
...
/*
 * bobgui_counting_bloom_filter_may_contain:
 * @self: a `BobguiCountingBloomFilter`
...
bobgui_counting_bloom_filter_may_contain (const BobguiCountingBloomFilter *self,
                                       guint16                       hash)
{
  guint16 bucket = hash % BOBGUI_COUNTING_BLOOM_FILTER_SIZE;
