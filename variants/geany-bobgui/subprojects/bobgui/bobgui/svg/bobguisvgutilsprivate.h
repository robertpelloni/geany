...
BobguiCssParser * parser_new_for_string (const char *string);

typedef gboolean (* ItemParseFunc) (BobguiCssParser *parser,
                                    gpointer      data);

gboolean parser_parse_list (BobguiCssParser  *parser,
                            ItemParseFunc  func,
                            gpointer       data);
...
gboolean parser_try_duration (BobguiCssParser *parser,
                              int64_t      *result);
...
gboolean parser_try_enum (BobguiCssParser  *parser,
                          const char   **values,
                          size_t         n_values,
                          unsigned int  *result);
...
void skip_whitespace_and_optional_comma (BobguiCssParser *parser);
