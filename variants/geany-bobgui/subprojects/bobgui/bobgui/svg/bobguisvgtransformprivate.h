...
#include "bobguisvgtypesprivate.h"
#include "bobguisvgenumsprivate.h"
#include "bobguisvgunitprivate.h"
...
SvgValue *     svg_transform_parse_css     (BobguiCssParser     *parser);

SvgValue *     primitive_transform_parse   (TransformType     type,
                                            const char       *value);
void           svg_primitive_transform_print
...
unsigned int css_parser_parse_number (BobguiCssParser *parser,
                                      unsigned int  n,
                                      gpointer      data);

unsigned int css_parser_parse_number_length (BobguiCssParser *parser,
                                             unsigned int  n,
                                             gpointer      data);

unsigned int css_parser_parse_number_angle (BobguiCssParser *parser,
                                            unsigned int  n,
                                            gpointer      data);

unsigned int css_parser_parse_number_percentage (BobguiCssParser *parser,
                                                 unsigned int  n,
                                                 gpointer      data);
