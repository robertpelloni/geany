                ...
                SvgFilterType  type)
{
  ...
  filter->css_node = bobgui_css_node_new ();
  bobgui_css_node_set_name (filter->css_node, g_quark_from_static_string (svg_filter_type_get_name (type)));
  bobgui_css_node_set_parent (filter->css_node, parent->css_node);
                   ...
                   const char *id)
{
  ...
  bobgui_css_node_set_id (filter->css_node, g_quark_from_string (id));
}
                         ...
                         GStrv      classes)
{
  ...
  bobgui_css_node_set_classes (filter->css_node, (const char **) filter->classes);
}
