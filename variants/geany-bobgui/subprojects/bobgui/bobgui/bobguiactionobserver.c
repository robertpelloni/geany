...
G_DEFINE_INTERFACE (BobguiActionObserver, bobgui_action_observer, G_TYPE_OBJECT)

/*< private >
 * BobguiActionObserver:
 *
 * `BobguiActionObserver` is a simple interface allowing objects that wish to
...
void
bobgui_action_observer_default_init (BobguiActionObserverInterface *class)
{
}

/*< private >
 * bobgui_action_observer_action_added:
 * @observer: a `BobguiActionObserver`
 ...
 */
void
bobgui_action_observer_action_added (BobguiActionObserver   *observer,
                                  ...
                                  GVariant            *state)
{
  g_return_if_fail (BOBGUI_IS_ACTION_OBSERVER (observer));

  BOBGUI_ACTION_OBSERVER_GET_IFACE (observer)
    ->action_added (observer, observable, action_name, parameter_type, enabled, state);
}

/*< private >
 * bobgui_action_observer_action_enabled_changed:
 * @observer: a `BobguiActionObserver`
 * @observable: the source of the event
 * @action_name: the name of the action
 * @enabled: %TRUE if the action is now enabled
 ...
 */
void
bobgui_action_observer_action_enabled_changed (BobguiActionObserver   *observer,
                                            BobguiActionObservable *observable,
                                            const char          *action_name,
                                            gboolean             enabled)
{
...
/*< private >
 * bobgui_action_observer_action_state_changed:
 * @observer: a `BobguiActionObserver`
 * @observable: the source of the event
 * @action_name: the name of the action
 ...
 */
void
bobgui_action_observer_action_state_changed (BobguiActionObserver   *observer,
                                          BobguiActionObservable *observable,
                                          const char          *action_name,
                                          GVariant            *state)
{
...
/*< private >
 * bobgui_action_observer_action_removed:
 * @observer: a `BobguiActionObserver`
 * @observable: the source of the event
 * @action_name: the name of the action
 *
 ...
 */
void
bobgui_action_observer_action_removed (BobguiActionObserver   *observer,
                                    BobguiActionObservable *observable,
                                    const char          *action_name)
{
  g_return_if_fail (BOBGUI_IS_ACTION_OBSERVER (observer));
...
/*< private >
 * bobgui_action_observer_primary_accel_changed:
 * @observer: a `BobguiActionObserver`
 * @observable: the source of the event
 ...
 */
void
bobgui_action_observer_primary_accel_changed (BobguiActionObserver   *observer,
                                           BobguiActionObservable *observable,
                                           const char          *action_name,
                                           const char          *action_and_target)
{
  BobguiActionObserverInterface *iface;

  g_return_if_fail (BOBGUI_IS_ACTION_OBSERVER (observer));

  iface = BOBGUI_ACTION_OBSERVER_GET_IFACE (observer);
