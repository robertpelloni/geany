...
G_DEFINE_TYPE (GraphRenderer, graph_renderer, BOBGUI_TYPE_WIDGET)
...
static void
graph_renderer_measure (BobguiWidget      *widget,
...
static void
graph_renderer_snapshot (BobguiWidget   *widget,
...
#define LINE_WIDTH 1.0
  ...
  x = LINE_WIDTH / 2.0;
  y = LINE_WIDTH / 2.0;
  width = bobgui_widget_get_width (widget) - LINE_WIDTH;
  height = bobgui_widget_get_height (widget) - LINE_WIDTH;
