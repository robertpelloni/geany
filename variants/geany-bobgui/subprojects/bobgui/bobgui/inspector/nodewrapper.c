...
struct _BobguiInspectorNodeWrapper
{
  GObject parent;
...
struct _BobguiInspectorNodeWrapperClass
{
  GObjectClass parent;
};
...
G_DEFINE_TYPE (BobguiInspectorNodeWrapper, bobgui_inspector_node_wrapper, G_TYPE_OBJECT)

static void
bobgui_inspector_node_wrapper_get_property (GObject    *object,
                                         guint       param_id,
                                         GValue     *value,
                                         GParamSpec *pspec)
{
  BobguiInspectorNodeWrapper *self = BOBGUI_INSPECTOR_NODE_WRAPPER (object);
...
static void
bobgui_inspector_node_wrapper_set_property (GObject      *object,
                                         guint         param_id,
                                         const GValue *value,
                                         GParamSpec   *pspec)
{
...
static void
bobgui_inspector_node_wrapper_dispose (GObject *object)
{
  BobguiInspectorNodeWrapper *self = BOBGUI_INSPECTOR_NODE_WRAPPER (object);
  ...
  G_OBJECT_CLASS (bobgui_inspector_node_wrapper_parent_class)->dispose (object);
}

static void
bobgui_inspector_node_wrapper_class_init (BobguiInspectorNodeWrapperClass *klass)
{
  GObjectClass *object_class = G_OBJECT_CLASS (klass);

  object_class->dispose = bobgui_inspector_node_wrapper_dispose;
  object_class->get_property = bobgui_inspector_node_wrapper_get_property;
  object_class->set_property = bobgui_inspector_node_wrapper_set_property;
...
static void
bobgui_inspector_node_wrapper_init (BobguiInspectorNodeWrapper *vis)
{
}
...
bobgui_inspector_node_wrapper_new (GskRenderNode *node,
                                ...
                                const char    *role)
{
  return g_object_new (BOBGUI_TYPE_INSPECTOR_NODE_WRAPPER,
                       "node", node,
...
GskRenderNode *
bobgui_inspector_node_wrapper_get_node (BobguiInspectorNodeWrapper *self)
{
  return self->node;
}

GskRenderNode *
bobgui_inspector_node_wrapper_get_profile_node (BobguiInspectorNodeWrapper *self)
{
  return self->profile_node;
}

const GskDebugProfile *
bobgui_inspector_node_wrapper_get_profile (BobguiInspectorNodeWrapper *self)
{
...
GskRenderNode *
bobgui_inspector_node_wrapper_get_draw_node (BobguiInspectorNodeWrapper *self)
{
  return self->draw_node;
}

const char *
bobgui_inspector_node_wrapper_get_role (BobguiInspectorNodeWrapper *self)
{
  return self->role;
}
...
GListModel *
bobgui_inspector_node_wrapper_create_children_model (BobguiInspectorNodeWrapper *self)
{
  ...
  store = g_list_store_new (BOBGUI_TYPE_INSPECTOR_NODE_WRAPPER);
  ...
  for (i = 0; i < n_children; i++)
    {
      BobguiInspectorNodeWrapper *child;

      child = bobgui_inspector_node_wrapper_new (children[i],
...
GskRenderNode *
bobgui_inspector_node_wrapper_render (BobguiInspectorNodeWrapper *self,
                                   NodeWrapperRendering     rendering)
{
  GdkTexture *texture;
