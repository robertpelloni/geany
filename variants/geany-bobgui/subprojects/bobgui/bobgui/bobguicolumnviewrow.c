 ...
 * BobguiColumnViewRow:
 *
 * Configures how rows are displayed in a [class@Bobgui.ColumnView].
 *
 * It is not used to set the widgets displayed in the individual cells. For that
 * see [method@BobguiColumnViewColumn.set_factory] and [class@BobguiColumnViewCell].
 *
 * Since: 4.12
 */

struct _BobguiColumnViewRowClass
{
...
G_DEFINE_TYPE (BobguiColumnViewRow, bobgui_column_view_row, G_TYPE_OBJECT)

static GParamSpec *properties[N_PROPS] = { NULL, };

static void
bobgui_column_view_row_dispose (GObject *object)
{
  BobguiColumnViewRow *self = BOBGUI_COLUMN_VIEW_ROW (object);

  g_clear_pointer (&self->accessible_description, g_free);
  g_clear_pointer (&self->accessible_label, g_free);

  G_OBJECT_CLASS (bobgui_column_view_row_parent_class)->dispose (object);
}

static void
bobgui_column_view_row_get_property (GObject    *object,
                                  guint       property_id,
                                  GValue     *value,
                                  GParamSpec *pspec)
{
...
static void
bobgui_column_view_row_set_property (GObject      *object,
                                  guint         property_id,
                                  const GValue *value,
                                  GParamSpec   *pspec)
{
  ...
  switch (property_id)
    {
    case PROP_ACCESSIBLE_DESCRIPTION:
      bobgui_column_view_row_set_accessible_description (self, g_value_get_string (value));
      break;

    case PROP_ACCESSIBLE_LABEL:
      bobgui_column_view_row_set_accessible_label (self, g_value_get_string (value));
      break;

    case PROP_ACTIVATABLE:
      bobgui_column_view_row_set_activatable (self, g_value_get_boolean (value));
      break;

    case PROP_FOCUSABLE:
      bobgui_column_view_row_set_focusable (self, g_value_get_boolean (value));
      break;

    case PROP_SELECTABLE:
      bobgui_column_view_row_set_selectable (self, g_value_get_boolean (value));
      break;
...
static void
bobgui_column_view_row_class_init (BobguiColumnViewRowClass *klass)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (klass);

  gobject_class->dispose = bobgui_column_view_row_dispose;
  gobject_class->get_property = bobgui_column_view_row_get_property;
  gobject_class->set_property = bobgui_column_view_row_set_property;

  /**
   * BobguiColumnViewRow:accessible-description:
   *
  ...
  /**
   * BobguiColumnViewRow:accessible-label:
   *
  ...
  /**
   * BobguiColumnViewRow:activatable:
   *
  ...
  /**
   * BobguiColumnViewRow:selectable:
   *
...
static void
bobgui_column_view_row_init (BobguiColumnViewRow *self)
{
...
BobguiColumnViewRow *
bobgui_column_view_row_new (void)
{
  return g_object_new (BOBGUI_TYPE_COLUMN_VIEW_ROW, NULL);
}

void
bobgui_column_view_row_do_notify (BobguiColumnViewRow *column_view_row,
...
/**
 * bobgui_column_view_row_get_item:
 * @self: a `BobguiColumnViewRow`
 *
 ...
 **/
gpointer
bobgui_column_view_row_get_item (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), NULL);
...
/**
 * bobgui_column_view_row_get_position:
 * @self: a `BobguiColumnViewRow`
 *
 ...
 */
guint
bobgui_column_view_row_get_position (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), BOBGUI_INVALID_LIST_POSITION);
...
/**
 * bobgui_column_view_row_get_selected:
 * @self: a `BobguiColumnViewRow`
 *
 ...
 */
gboolean
bobgui_column_view_row_get_selected (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), FALSE);
...
/**
 * bobgui_column_view_row_get_selectable:
 * @self: a `BobguiColumnViewRow`
 *
 * Checks if the row has been set to be selectable via
 * bobgui_column_view_row_set_selectable().
 *
 * Do not confuse this function with [method@Bobgui.ColumnViewRow.get_selected].
 *
 ...
 */
gboolean
bobgui_column_view_row_get_selectable (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), FALSE);
 ...
 */
void
bobgui_column_view_row_set_selectable (BobguiColumnViewRow *self,
                                    gboolean          selectable)
{
  g_return_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self));
...
/**
 * bobgui_column_view_row_get_activatable:
 * @self: a `BobguiColumnViewRow`
 *
 * Checks if the row has been set to be activatable via
 * bobgui_column_view_row_set_activatable().
 *
 ...
 */
gboolean
bobgui_column_view_row_get_activatable (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), FALSE);
 ...
 * the Return key or calling bobgui_widget_activate() will activate
 * the row. Activating instructs the containing columnview to 
 * emit the [signal@Bobgui.ColumnView::activate] signal.
 *
 ...
 */
void
bobgui_column_view_row_set_activatable (BobguiColumnViewRow *self,
...
/**
 * bobgui_column_view_row_get_focusable:
 * @self: a `BobguiColumnViewRow`
 *
 * Checks if a row item has been set to be focusable via
 * bobgui_column_view_row_set_focusable().
 *
 ...
 */
gboolean
bobgui_column_view_row_get_focusable (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), FALSE);
 ...
 */
void
bobgui_column_view_row_set_focusable (BobguiColumnViewRow *self,
                                   gboolean          focusable)
{
  g_return_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self));
...
/**
 * bobgui_column_view_row_get_accessible_description:
 * @self: a `BobguiColumnViewRow`
 *
 ...
 */
const char *
bobgui_column_view_row_get_accessible_description (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), NULL);
...
/**
 * bobgui_column_view_row_set_accessible_description:
 * @self: a `BobguiColumnViewRow`
 ...
 */
void
bobgui_column_view_row_set_accessible_description (BobguiColumnViewRow *self,
...
/**
 * bobgui_column_view_row_get_accessible_label:
 * @self: a `BobguiColumnViewRow`
 *
 ...
 */
const char *
bobgui_column_view_row_get_accessible_label (BobguiColumnViewRow *self)
{
  g_return_val_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self), NULL);
...
/**
 * bobgui_column_view_row_set_accessible_label:
 * @self: a `BobguiColumnViewRow`
 * @label: the label
 *
 ...
 */
void
bobgui_column_view_row_set_accessible_label (BobguiColumnViewRow *self,
                                    const char  *label)
{
  g_return_if_fail (BOBGUI_IS_COLUMN_VIEW_ROW (self));
