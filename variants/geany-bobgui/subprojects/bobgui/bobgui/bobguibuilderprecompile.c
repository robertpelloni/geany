...
/**
 * _bobgui_buildable_parser_precompile:
 * @text: chunk of text to parse
 * @text_len: length of @text in bytes
 *
 * Converts the xml format typically used by BobguiBuilder to a
 * binary form that is more efficient to parse. This is a custom
 * format that is only supported by BobguiBuilder.
 *
 * returns: A `GBytes` with the precompiled data
 **/
GBytes *
_bobgui_buildable_parser_precompile (const char  *text,
                                  gssize       text_len,
                                  GError     **error)
{
...
static void
propagate_error (BobguiBuildableParseContext *context,
                 GError                  **dest,
                 GError                   *src)
{
...
static gboolean
replay_start_element (BobguiBuildableParseContext  *context,
                      const char               **tree,
                      const char                *strings,
                      GError                   **error)
{
...
static gboolean
replay_end_element (BobguiBuildableParseContext  *context,
                    const char               **tree,
                    const char                *strings,
                    GError                   **error)
{
...
static gboolean
replay_text (BobguiBuildableParseContext  *context,
             const char               **tree,
             const char                *strings,
             GError                   **error)
{
...
gboolean
_bobgui_buildable_parser_is_precompiled (const char *data,
                                      gssize      data_len)
{
  return
    data_len > 4 &&
...
gboolean
_bobgui_buildable_parser_replay_precompiled (BobguiBuildableParseContext  *context,
                                          const char                *data,
                                          gssize                     data_len,
                                          GError                   **error)
{
