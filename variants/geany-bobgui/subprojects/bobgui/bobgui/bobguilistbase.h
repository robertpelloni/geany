...
#define BOBGUI_TYPE_LIST_BASE         (bobgui_list_base_get_type ())
#define BOBGUI_LIST_BASE(o)           (G_TYPE_CHECK_INSTANCE_CAST ((o), BOBGUI_TYPE_LIST_BASE, BobguiListBase))
#define BOBGUI_LIST_BASE_CLASS(k)     (G_TYPE_CHECK_CLASS_CAST ((k), BOBGUI_TYPE_LIST_BASE, BobguiListBaseClass))
#define BOBGUI_IS_LIST_BASE(o)        (G_TYPE_CHECK_INSTANCE_TYPE ((o), BOBGUI_TYPE_LIST_BASE))
#define BOBGUI_IS_LIST_BASE_CLASS(k)  (G_TYPE_CHECK_CLASS_TYPE ((k), BOBGUI_TYPE_LIST_BASE))
#define BOBGUI_LIST_BASE_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), BOBGUI_TYPE_LIST_BASE, BobguiListBaseClass))

/**
 * BobguiListBase:
 *
 * The abstract base class for BOBGUI's list widgets.
 *
 * # Shortcuts and Gestures
 *
 * `BobguiListBase` supports the following keyboard shortcuts:
 *
 ...
 * # Actions
 *
 * `BobguiListBase` defines a set of built-in actions:
 *
 ...
 */
typedef struct _BobguiListBase BobguiListBase;
typedef struct _BobguiListBaseClass BobguiListBaseClass;

GDK_AVAILABLE_IN_ALL
GType                   bobgui_list_base_get_type                  (void) G_GNUC_CONST;
