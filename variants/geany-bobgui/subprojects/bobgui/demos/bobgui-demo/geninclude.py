...
def is_keyword(s):
    if s == "BOBGUI":
        return False
    elif s.startswith(("Bobgui", "Gdk", "Pango")):
        return True
...
file_output = """
typedef BobguiWidget *(*GDoDemoFunc) (BobguiWidget *do_widget);
...
for demo_file in in_files:
    ...
    file_output += "BobguiWidget *do_" + demo_name + " (BobguiWidget *do_widget);\n"
