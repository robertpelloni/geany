/* Lists/Minesweeper
 * #Keywords: BobguiGridView, GListModel, game
 *
...
minesweeper_cell_clicked_cb (BobguiGridView *gridview,
                             guint        pos,
                             SweeperGame *game)
{
...
G_MODULE_EXPORT void
minesweeper_new_game_cb (BobguiButton   *button,
                         SweeperGame *game)
{
...
BobguiWidget *
do_listview_minesweeper (BobguiWidget *do_widget)
{
  if (window == NULL)
    {
      ...
      builder = bobgui_builder_new_from_resource ("/listview_minesweeper/listview_minesweeper.ui");
