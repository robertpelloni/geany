 ...
 * #Keywords: BobguiLayoutManager, GskTransform
 *
...
BobguiWidget *
do_layoutmanager2 (BobguiWidget *parent)
{
  ...
  if (!window)
    {
      ...
      bobgui_window_set_title (BOBGUI_WINDOW (window), "Layout Manager — Transformation");
      bobgui_window_set_default_size (BOBGUI_WINDOW (window), 600, 620);
      ...
      for (i = 0; i < 18 * 36; i++)
        {
          child = bobgui_image_new_from_icon_name (name[i % G_N_ELEMENTS (name)]);
