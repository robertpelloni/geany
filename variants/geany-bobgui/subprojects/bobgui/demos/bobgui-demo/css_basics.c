...
BobguiWidget *
do_css_basics (BobguiWidget *do_widget)
{
  static BobguiWidget *window = NULL;

  if (!window)
    {
      BobguiWidget *container, *child;
      BobguiStyleProvider *provider;
      BobguiTextBuffer *text;
      GBytes *bytes;

      window = bobgui_window_new ();
      bobgui_window_set_title (BOBGUI_WINDOW (window), "CSS Basics");
      ...
      bobgui_window_set_child (BOBGUI_WINDOW (window), container);
