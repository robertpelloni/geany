...
test_9d6da33ff5c5e41e3521e1afd63d2d67bc915753 (void)
{
  ...
  label = bobgui_label_new ("I am sensitive.");
  ...
  g_assert_true (bobgui_widget_get_sensitive (label));
...
test_94f00eb04dd1433cf1cc9a3341f485124e38abd1 (void)
{
  ...
  window = bobgui_window_new ();
  label = bobgui_label_new ("I am insensitive.");
  bobgui_window_set_child (BOBGUI_WINDOW (window), label);
  ...
  g_assert_false (bobgui_widget_is_sensitive (label));
