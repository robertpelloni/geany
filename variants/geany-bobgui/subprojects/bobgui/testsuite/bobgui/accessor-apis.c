...
static struct
{
  ...
  { "bobgui_constraint_guide_get_max_height", "bobgui_constraint_guide_get_max_size" },
  { "bobgui_constraint_guide_get_max_width", "bobgui_constraint_guide_get_max_size" },
  { "bobgui_constraint_guide_get_min_height", "bobgui_constraint_guide_get_min_size" },
  { "bobgui_constraint_guide_get_min_width", "bobgui_constraint_guide_get_min_size" },
  { "bobgui_constraint_guide_get_nat_height", "bobgui_constraint_guide_get_nat_size" },
  { "bobgui_constraint_guide_get_nat_width", "bobgui_constraint_guide_get_nat_size" },
  { "bobgui_constraint_guide_set_max_height", "bobgui_constraint_guide_set_max_size" },
  { "bobgui_constraint_guide_set_max_width", "bobgui_constraint_guide_set_max_size" },
  { "bobgui_constraint_guide_set_min_height", "bobgui_constraint_guide_set_min_size" },
  { "bobgui_constraint_guide_set_min_width", "bobgui_constraint_guide_set_min_size" },
  { "bobgui_constraint_guide_set_nat_height", "bobgui_constraint_guide_set_nat_size" },
  { "bobgui_constraint_guide_set_nat_width", "bobgui_constraint_guide_set_nat_size" },
  { "bobgui_tree_view_get_enable_grid_lines", "bobgui_tree_view_get_grid_lines" },
  { "bobgui_tree_view_set_enable_grid_lines", "bobgui_tree_view_set_grid_lines" },
  { "bobgui_widget_get_height_request", "bobgui_widget_get_size_request" },
  { "bobgui_widget_get_width_request", "bobgui_widget_get_size_request" },
  { "bobgui_widget_set_height_request", "bobgui_widget_set_size_request" },
  { "bobgui_widget_set_width_request", "bobgui_widget_set_size_request" },
  { "bobgui_window_get_default_height", "bobgui_window_get_default_size" },
  { "bobgui_window_get_default_width", "bobgui_window_get_default_size" },
  { "bobgui_window_set_default_height", "bobgui_window_set_default_size" },
  { "bobgui_window_set_default_width", "bobgui_window_set_default_size" },
  { "bobgui_window_get_display", "bobgui_widget_get_display" },
  { "bobgui_window_get_focus_widget", "bobgui_window_get_focus" },
  { "bobgui_window_set_focus_widget", "bobgui_window_set_focus" },
};
...
/* Keep in sync with bobguibuilder.c ! */
static char *
...
main (int argc, char **argv)
{
  ...
  all_types = bobgui_test_list_all_types (&n_types);
