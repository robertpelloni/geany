/* Extensive BobguiListStore tests.
	     ...
	     BobguiTreeIter *b)
{
  ...
  /* user_data2 and user_data3 are not used in BobguiListStore */

  return TRUE;
}

static gboolean
iter_position (BobguiListStore *store,
	       BobguiTreeIter  *iter,
	       int           n)
{
  gboolean ret = TRUE;
		  ...
		  gconstpointer  test_data)
{
  ...
  fixture->store = bobgui_list_store_new (1, G_TYPE_INT);

  for (i = 0; i < 5; i++)
    {
      bobgui_list_store_insert (fixture->store, &fixture->iter[i], i);
      bobgui_list_store_set (fixture->store, &fixture->iter[i], 0, i, -1);
    }
}
	     ...
	     int        skip)
{
  ...
  for (i = 0; i < 5; i++)
	...
	continue;
      ...
      g_assert_true (bobgui_list_store_iter_is_valid (fixture->store, &iter));
...
list_store_test_insert_high_values (void)
{
  ...
  bobgui_list_store_insert (store, &iter, 1234);
  g_assert_true (bobgui_list_store_iter_is_valid (store, &iter));
  ...
  bobgui_list_store_insert (store, &iter2, 765);
  g_assert_true (bobgui_list_store_iter_is_valid (store, &iter2));
...
list_store_test_prepend (void)
{
  ...
  bobgui_list_store_prepend (store, &iter2);
  g_assert_true (bobgui_list_store_iter_is_valid (store, &iter2));
  g_assert_cmpint (bobgui_tree_model_iter_n_children (BOBGUI_TREE_MODEL (store), NULL), ==, 2);
...
list_store_test_insert_after (void)
{
  ...
  bobgui_list_store_insert_after (store, &iter3, &iter);
  g_assert_true (bobgui_list_store_iter_is_valid (store, &iter3));
...
list_store_test_insert_after_NULL (void)
{
  ...
  bobgui_list_store_insert_after (store, &iter2, NULL);
  g_assert_true (bobgui_list_store_iter_is_valid (store, &iter2));
  g_assert_cmpint (bobgui_tree_model_iter_n_children (BOBGUI_TREE_MODEL (store), NULL), ==, 2);
...
list_store_test_insert_before (void)
{
  ...
  bobgui_list_store_insert_before (store, &iter3, &iter2);
  g_assert_true (bobgui_list_store_iter_is_valid (store, &iter3));
  g_assert_cmpint (bobgui_tree_model_iter_n_children (BOBGUI_TREE_MODEL (store), NULL), ==, 3);
  g_assert_true (bobgui_tree_model_iter_nth_child (BOBGUI_TREE_MODEL (store), &iter_copy, NULL, 1));
  g_assert_true (iters_equal (&iter3, &iter_copy));
...
list_store_test_insert_before_NULL (void)
{
  ...
  bobgui_list_store_insert_before (store, &iter2, NULL);
  g_assert_true (bobgui_list_store_iter_is_valid (store, &iter2));
  g_assert_cmpint (bobgui_tree_model_iter_n_children (BOBGUI_TREE_MODEL (store), NULL), ==, 2);
...
list_store_set_gvalue_to_transform (void)
{
  ...
  store = bobgui_list_store_new (1, G_TYPE_LONG);
  bobgui_list_store_append (store, &iter);

  g_value_init (&value, G_TYPE_INT);
  g_value_set_int (&value, 42);
  bobgui_list_store_set_value (store, &iter, 0, &value);
}
			      ...
			      gconstpointer  user_data)
{
  ...
  g_assert_true (bobgui_list_store_remove (fixture->store, &iter));
  g_assert_false (bobgui_list_store_iter_is_valid (fixture->store, &fixture->iter[0]));
			       ...
			       gconstpointer  user_data)
{
  ...
  g_assert_true (bobgui_list_store_remove (fixture->store, &iter));
  g_assert_false (bobgui_list_store_iter_is_valid (fixture->store, &fixture->iter[2]));
			    ...
			    gconstpointer  user_data)
{
  ...
  g_assert_false (bobgui_list_store_remove (fixture->store, &iter));
  g_assert_false (bobgui_list_store_iter_is_valid (fixture->store, &fixture->iter[4]));
		       ...
		       gconstpointer  user_data)
{
  ...
  bobgui_list_store_clear (fixture->store);

  g_assert_cmpint (bobgui_tree_model_iter_n_children (BOBGUI_TREE_MODEL (fixture->store), NULL), ==, 0);

  for (i = 0; i < 5; i++)
    g_assert_true (!bobgui_list_store_iter_is_valid (fixture->store, &fixture->iter[i]));
}
			 ...
			 gconstpointer  user_data)
{
  ...
  bobgui_list_store_reorder (fixture->store, new_order);
		            ...
		            gconstpointer  user_data)
{
  ...
  bobgui_list_store_swap (fixture->store, &iter_a, &iter_b);
  check_model (fixture, new_order, -1);
}
...
list_store_test_swap_single (void)
{
  ...
  bobgui_list_store_swap (store, &iter, &iter);
  g_assert_true (iters_equal (&iter, &iter_copy));
				       ...
				       gconstpointer  user_data)
{
  ...
  bobgui_list_store_move_after (fixture->store, &iter, &position);
  check_model (fixture, new_order, -1);
}
			         ...
			         gconstpointer  user_data)
{
  ...
  bobgui_list_store_move_after (fixture->store, &iter, NULL);
  check_model (fixture, new_order, -1);
}
...
list_store_test_move_after_single (void)
{
  ...
  bobgui_list_store_move_after (store, &iter, NULL);
  g_assert_true (iters_equal (&iter, &iter_copy));
  g_assert_true (bobgui_tree_model_get_iter_first (BOBGUI_TREE_MODEL (store), &iter));
  g_assert_true (iters_equal (&iter, &iter_copy));

  bobgui_list_store_move_after (store, &iter, &iter);
  g_assert_true (iters_equal (&iter, &iter_copy));
  g_assert_true (bobgui_tree_model_get_iter_first (BOBGUI_TREE_MODEL (store), &iter));
  g_assert_true (iters_equal (&iter, &iter_copy));
		                  ...
		                  gconstpointer  user_data)
{
  ...
  bobgui_list_store_move_before (fixture->store, &iter, &position);
  check_model (fixture, new_order, -1);
}
			          ...
			          gconstpointer  user_data)
{
  ...
  bobgui_list_store_move_before (fixture->store, &iter, NULL);
  check_model (fixture, new_order, -1);
}
...
list_store_test_move_before_single (void)
{
  ...
  bobgui_list_store_move_before (store, &iter, NULL);
  g_assert_true (iters_equal (&iter, &iter_copy));
  g_assert_true (bobgui_tree_model_get_iter_first (BOBGUI_TREE_MODEL (store), &iter));
  g_assert_true (iters_equal (&iter, &iter_copy));

  bobgui_list_store_move_before (store, &iter, &iter);
  g_assert_true (iters_equal (&iter, &iter_copy));
  g_assert_true (bobgui_tree_model_get_iter_first (BOBGUI_TREE_MODEL (store), &iter));
  g_assert_true (iters_equal (&iter, &iter_copy));
                                       ...
                                       gconstpointer  user_data)
{
  ...
  g_assert_false (bobgui_tree_model_iter_previous (BOBGUI_TREE_MODEL (fixture->store),
                                          &iter));
  g_assert_false (bobgui_list_store_iter_is_valid (fixture->store, &iter));
                                       ...
                                       gconstpointer  user_data)
{
  ...
  g_assert_false (bobgui_tree_model_iter_children (BOBGUI_TREE_MODEL (fixture->store),
                                                &child, &iter));
  g_assert_false (bobgui_list_store_iter_is_valid (fixture->store, &child));
                                     ...
                                     gconstpointer  user_data)
{
  ...
  g_assert_true (bobgui_list_store_iter_is_valid (fixture->store, &child));
