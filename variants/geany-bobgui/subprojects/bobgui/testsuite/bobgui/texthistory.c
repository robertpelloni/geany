...
static BobguiTextHistoryFuncs funcs = {
  do_change_state,
  do_insert,
  do_delete,
  do_select,
...
text_new (void)
{
  ...
  text->history = bobgui_text_history_new (&funcs, text);
                ...
                Text          *text)
{
  do_insert (text,
             ...
             cmd->text,
             strlen (cmd->text));
  bobgui_text_history_text_inserted (text->history, cmd->location, cmd->text, -1);
}
                    ...
                    Text          *text)
{
  do_delete (text,
             ...
             cmd->text,
             strlen (cmd->text));
  bobgui_text_history_text_deleted (text->history,
                                 cmd->location,
                                 cmd->end_location,
                                 cmd->text,
...
command_undo (const Command *cmd,
              Text          *text)
{
  bobgui_text_history_undo (text->history);
}
...
command_redo (const Command *cmd,
              Text          *text)
{
  bobgui_text_history_redo (text->history);
}
...
set_selection (Text *text,
               ...
               int   end)
{
  bobgui_text_history_selection_changed (text->history, begin, end);
}
          ...
          guint          max_undo)
{
  ...
  if (max_undo)
    bobgui_text_history_set_max_undo_levels (text->history, max_undo);
  ...
  for (guint i = 0; i < n_commands; i++)
    {
      ...
      switch (cmd->kind)
        ...
        case BEGIN_USER:
          bobgui_text_history_begin_user_action (text->history);
          break;

        case END_USER:
          bobgui_text_history_end_user_action (text->history);
          break;

        case BEGIN_IRREVERSIBLE:
          bobgui_text_history_begin_irreversible_action (text->history);
          break;

        case END_IRREVERSIBLE:
          bobgui_text_history_end_irreversible_action (text->history);
          break;

        case MODIFIED:
          bobgui_text_history_modified_changed (text->history, TRUE);
          break;

        case UNMODIFIED:
          bobgui_text_history_modified_changed (text->history, FALSE);
          break;

        case SELECT:
          bobgui_text_history_selection_changed (text->history,
                                              cmd->location,
                                              cmd->end_location);
          break;
        ...
        case SET_MAX_UNDO:
          ...
          bobgui_text_history_set_max_undo_levels (text->history, cmd->location);
          break;
      ...
      char *argv[])
{
  ...
  g_test_add_func ("/Bobgui/TextHistory/test1", test1);
  g_test_add_func ("/Bobgui/TextHistory/test2", test2);
  g_test_add_func ("/Bobgui/TextHistory/test3", test3);
  g_test_add_func ("/Bobgui/TextHistory/test4", test4);
  g_test_add_func ("/Bobgui/TextHistory/test5", test5);
  g_test_add_func ("/Bobgui/TextHistory/test6", test6);
  g_test_add_func ("/Bobgui/TextHistory/test7", test7);
  g_test_add_func ("/Bobgui/TextHistory/test8", test8);
  g_test_add_func ("/Bobgui/TextHistory/test9", test9);
  g_test_add_func ("/Bobgui/TextHistory/test10", test10);
  g_test_add_func ("/Bobgui/TextHistory/test11", test11);
  g_test_add_func ("/Bobgui/TextHistory/test12", test12);
  g_test_add_func ("/Bobgui/TextHistory/test13", test13);
  g_test_add_func ("/Bobgui/TextHistory/test14", test14);
  g_test_add_func ("/Bobgui/TextHistory/issue_4276", test_issue_4276);
  g_test_add_func ("/Bobgui/TextHistory/issue_4575", test_issue_4575);
  g_test_add_func ("/Bobgui/TextHistory/issue_5777", test_issue_5777);
