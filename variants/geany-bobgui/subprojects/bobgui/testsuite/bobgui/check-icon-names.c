...
{
  BobguiIconTheme *icon_theme = bobgui_icon_theme_get_for_display (gdk_display_get_default ());
   ...
   */
  info = bobgui_icon_theme_lookup_icon (icon_theme, icon_name, NULL, 16, 1, BOBGUI_TEXT_DIR_LTR, 0);
  if (info == NULL)
    {
...
main (int argc, char *argv[])
{
  ...
  g_object_get (bobgui_settings_get_default (), "bobgui-icon-theme-name", &theme, NULL);
