...
# put a 20x20 size-requested BobguiTreeView into a 40x40 size-requested
# container and try to achieve multiple combinations of expand and align
# flags. The resulting BobguiBuilder file is written to stdout. All of the
# resulting files should render identical.
#
# METHOD is one of:
# * flags (default)
#   Uses expand flags to align and expand the treeview inside a BobguiGrid.
#   You should use this as the reference when adding tests for other
#   methods
# * alignment
#   Aligns and expands the treeview in a BobguiAlignment using its scale
...
cat << EOF
        <child>
          <object class="BobguiLabel" id="hexpand-$halign-$hexpand">
            <property name="visible">True</property>
            <property name="can_focus">False</property>
        ...
        <child>
          <object class="BobguiLabel" id="halign-$halign-$hexpand">
            <property name="visible">True</property>
            <property name="can_focus">False</property>
...
cat << EOF
        <child>
          <object class="BobguiLabel" id="vexpand-$valign-$vexpand">
            <property name="visible">True</property>
            <property name="can_focus">False</property>
        ...
        <child>
          <object class="BobguiLabel" id="valign-$valign-$vexpand">
            <property name="visible">True</property>
            <property name="can_focus">False</property>
...
cat << EOF
        <child>
          <object class="BobguiGrid" id="grid-$valign-$halign-$vexpand-$hexpand">
            <property name="width_request">40</property>
            <property name="height_request">40</property>
            <property name="visible">True</property>
            <property name="can_focus">False</property>
            <child>
              <object class="BobguiTreeView" id="treeview-$valign-$halign-$vexpand-$hexpand">
...
cat << EOF
        <child>
          <object class="BobguiAlignment" id="align-$valign-$halign-$vexpand-$hexpand">
            <property name="width_request">40</property>
            <property name="height_request">40</property>
            <property name="visible">True</property>
            <property name="can_focus">False</property>
