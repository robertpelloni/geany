# Bobgui Handoff — 2026-04-05 — C++ Workspace Surface Presets
...
### 1. AppShell workspace/panel surfaces
...
This means the shell can now derive focused workspace and panel action surfaces without asking callers to manually filter section data.

### 2. Preset-family integration
Higher-level presets now align with the same surface helpers:
- `StudioShell` exposes workspace/panel toolbar presets
- `DocumentShell` maps its toolbar helpers onto workspace/panel presets
