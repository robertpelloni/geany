...
This chapter describes how BOBGUI uses CSS for styling and layout.
...
BOBGUI applies the style information found in style sheets by matching
...
### The CSS nodes of a BobguiScale
...
| E:link, E:visited | [CSS Selector Level 3](https://www.w3.org/TR/css3-selectors/#link) | Corresponds to BOBGUI_STATE_FLAG_LINK and BOBGUI_STATE_FLAGS_VISITED |
| E:active, E:hover, E:focus | [CSS Selector Level 3](https://www.w3.org/TR/css3-selectors/#useraction-pseudos) | Correspond to BOBGUI_STATE_FLAG_ACTIVE, BOBGUI_STATE_FLAG_PRELIGHT, BOBGUI_STATE_FLAGS_FOCUSED |
...
| E:disabled | [CSS Selector Level 3](https://www.w3.org/TR/css3-selectors/#UIstates) | Corresponds to BOBGUI_STATE_FLAG_INSENSITIVE |
| E:checked | [CSS Selector Level 3](https://www.w3.org/TR/css3-selectors/#UIstates) | Corresponds to BOBGUI_STATE_FLAG_CHECKED |
| E:indeterminate | [CSS Selector Level 3](https://www.w3.org/TR/css3-selectors/#indeterminate) | Corresponds to BOBGUI_STATE_FLAG_INCONSISTENT |
| E:backdrop, E:selected | | Corresponds to BOBGUI_STATE_FLAG_BACKDROP, BOBGUI_STATE_FLAG_SELECTED |
