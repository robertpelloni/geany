Title: Using BOBGUI with Wayland
Slug: bobgui-wayland

The GDK Wayland backend provides support for running BOBGUI applications
...
See the [documentation](https://docs.bobgui.org/gdk4-wayland/) for
