...
SYNOPSIS
--------
|   **bobgui4-path-tool** <COMMAND> [OPTIONS...] <PATH>
|
|   **bobgui4-path-tool** decompose [OPTIONS...] <PATH>
|   **bobgui4-path-tool** show [OPTIONS...] <PATH>...
|   **bobgui4-path-tool** render [OPTIONS...] <PATH>...
|   **bobgui4-path-tool** reverse [OPTIONS...] <PATH>
|   **bobgui4-path-tool** info [OPTIONS...] <PATH>

DESCRIPTION
-----------

``bobgui4-path-tool`` can perform various tasks on paths. Paths are specified
