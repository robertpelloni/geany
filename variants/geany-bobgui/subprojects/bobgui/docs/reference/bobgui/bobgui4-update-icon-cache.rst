.. _bobgui4-update-icon-cache(1):

======================
bobgui4-update-icon-cache
======================
...
|   **bobgui4-update-icon-cache** [OPTIONS...] <PATH>

DESCRIPTION
-----------

``bobgui4-update-icon-cache`` creates ``mmap(2)``-able cache files for icon themes.
...
BOBGUI can use the cache files created by ``bobgui4-update-icon-cache`` to avoid a lot
...
``-t, --ignore-theme-index``
  ...
  Without this option, ``bobgui4-update-icon-cache`` refuses to create an icon
