...
To mix low-level Xlib routines into a BOBGUI program, see
...
See the [documentation](https://docs.bobgui.org/gdk4-x11/) for
...
The GDK manual covers [using Xlib in a BOBGUI program](https://docs.bobgui.org/gdk4/x11.html).
...
BOBGUI has functions for asking the window manager to do various things;
see for example [method@Bobgui.Window.minimize] or [method@Bobgui.Window.maximize].
