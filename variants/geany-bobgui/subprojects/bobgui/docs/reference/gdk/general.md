...
The GDK and BOBGUI headers annotate deprecated APIs in a way that produces
compiler warnings if these deprecated APIs are used. The warnings
can be turned off by defining the macro `GDK_DISABLE_DEPRECATION_WARNINGS`
before including the `gdk.h` header.

GDK and BOBGUI also provide support for building applications against defined
...
a function deprecated before the version of BOBGUI specified in
`GDK_VERSION_MIN_REQUIRED`, or a function introduced after the version of
BOBGUI specified in `GDK_VERSION_MAX_ALLOWED`, the compiler will warn you when
building your code.
