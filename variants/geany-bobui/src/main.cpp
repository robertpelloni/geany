...
public:
    SearchStudioDialog()
    {
        ...
        auto *hero = new QLabel(
            ...
            "<p>Experimental BobUI-native search surface mirroring the matured Search Studio model from the main tree: "
        ...
        appendResult(
            ...
            "Search Studio",
            "Select a result row to inspect richer preview text. This BobUI prototype mirrors the current Search Studio navigator model.",
            false);
    ...
    QWidget *createFindTab()
    {
        ...
        auto addFindButton = [&](const QString &label, const QString &activity, const QString &summary) {
            ...
            connect(button, &QPushButton::clicked, this, [this, activity, summary]() {
                ...
                action.summaryPreviewBody = QString("Prototype action: %1\n\nQuery: %2\nMode: %3\n\nThis BobUI surface mirrors the current Search Studio workflow but is not yet wired to Geany core services.")
